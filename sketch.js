...
function setup() {
	...
	rope1= new Rope(bobObject1.body,roof.body,20*2, 0);
	rope2= new Rope(bobObject2.body,roof.body,40*2,0);
	rope3= new Rope(bobObject3.body,roof.body,60*2,0);
	rope4= new Rope(bobObject4.body,roof.body,80*2,0);
